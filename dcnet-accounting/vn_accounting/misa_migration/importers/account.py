...
_TYPE_RULES = [
    ...
    ("Dư Có", "331", "Payable"),
    # 131/331 are "Lưỡng tính" (dual-nature) in Misa's Tính chất column —
    # the Dư Nợ/Dư Có rules above never fire for them, leaving account_type
    # blank → every SI ("Debit To must be Receivable") and PI ("Credit To
    # must be Payable") insert then fails on a fresh company (E2E 2026-06-11,
    # 30k Failed rows). Misa exports both "Lưỡng tính" and "Dư Nợ, Dư Có".
    ("Lưỡng", "131", "Receivable"),
    ("Lưỡng", "331", "Payable"),
    ("Dư Nợ, Dư Có", "131", "Receivable"),
    ("Dư Nợ, Dư Có", "331", "Payable"),
    ("Dư Nợ", "152", "Stock"),
    ("Dư Nợ", "153", "Stock"),
    ("Dư Nợ", "156", "Stock"),
