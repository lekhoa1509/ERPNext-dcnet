...
summary: Khai báo dữ liệu nền — hệ thống tài khoản, khách hàng, nhà cung cấp, ngân hàng, hàng hóa, kho, nhân viên và định mức vật tư — làm cơ sở cho mọi nghiệp vụ và định khoản.
---

## Mục đích

Phân hệ **Danh mục** là nơi khai báo **dữ liệu nền** (master data) cho toàn bộ hệ thống kế toán: hệ thống tài khoản, đối tượng công nợ (khách hàng, nhà cung cấp), ngân hàng, hàng hóa – vật tư, kho, nhân viên và định mức vật tư. Đây là "từ điển" mà mọi chứng từ và báo cáo tham chiếu tới.
...
- **Khi thiết lập ban đầu:** dựng hệ thống tài khoản theo Thông tư 99/2025/TT-BTC, khai báo danh sách khách hàng / nhà cung cấp / ngân hàng / mặt hàng / kho hiện có.
...
| 4 | Ngân hàng | Danh mục | Danh sách ngân hàng dùng cho tài khoản ngân hàng và đối soát |
| 5 | Hàng hóa, vật tư | Danh mục | Mặt hàng kinh doanh / vật tư, đơn vị tính, TK mặc định |
| 6 | Kho | Danh mục | Kho vật lý gắn với tài khoản hàng tồn kho (152/153/155/156) |
| 7 | Nhân viên | Danh mục | Hồ sơ nhân sự dùng cho tạm ứng (141) và tiền lương (334) |
| 8 | Định mức vật tư | Danh mục | Định mức nguyên vật liệu cho 1 đơn vị thành phẩm (dùng cho giá thành) |
...
5. **Khai báo ngân hàng** trước khi tạo tài khoản ngân hàng chi tiết cho công ty.
6. **Khai báo nhân viên** phục vụ tạm ứng và tính lương. Xem [Nhân viên](nhan-vien.md).
7. **Khai báo định mức vật tư** cho doanh nghiệp sản xuất, làm cơ sở tính giá thành. Xem [Định mức vật tư](dinh-muc-vat-tu.md).
...
- [Ngân hàng](ngan-hang.md) · [Hàng hóa, vật tư](hang-hoa-vat-tu.md) · [Kho](kho.md)
