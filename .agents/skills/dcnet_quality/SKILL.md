...
When Codex detects ERPNext/Frappe code patterns in the task, it MUST:
...
All skills are in `.Codex/skills/dcnet_quality/`:
...
## DCNET Coding Standards (Extracted from frappe-Codex best practices)
