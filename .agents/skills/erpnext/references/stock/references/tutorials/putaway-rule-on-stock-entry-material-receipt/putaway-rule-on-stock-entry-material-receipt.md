# How To: Putaway Rule On Stock Entry Material Receipt
...
Workflow: Test if rules are applied in Stock Entry of type Receipt.
...
### Step 1: 'Test if rules are applied in Stock Entry of type Receipt.'
...
*Source: test_putaway_rule.py:417 | Complexity: Advanced | Last updated: 2026-02-04*