# How To: Returning Partial Bundles
...
Workflow: test returning partial bundles
...
### Step 7: Call dn_ret.items.pop()

```python
dn_ret.items.pop()
```

### Step 8: Call dn_ret.save()

```python
dn_ret.save()
```

### Step 9: Call dn_ret.submit()

```python
dn_ret.submit()
```

### Step 10: Call dn_ret.reload()
...
*Source: test_packed_item.py:221 | Complexity: Advanced | Last updated: 2026-02-04*