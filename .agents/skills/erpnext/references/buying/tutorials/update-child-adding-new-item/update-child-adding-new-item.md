...
### Step 6: Call po.load_from_db()

```python
po.load_from_db()
```

### Step 7: Assign existing_ordered_qty = get_ordered_qty(...)

```python
existing_ordered_qty = get_ordered_qty()
```

### Step 8: Assign first_item_of_po = value
...
*Source: test_purchase_order.py:205 | Complexity: Advanced | Last updated: 2026-02-04*