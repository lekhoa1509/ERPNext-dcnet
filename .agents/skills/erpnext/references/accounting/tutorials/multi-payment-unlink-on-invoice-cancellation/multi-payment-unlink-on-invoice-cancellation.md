# How To: Multi Payment Unlink On Invoice Cancellation
...
Workflow: test multi payment unlink on invoice cancellation
...
### Step 11: Assign pe.paid_amount = amt

```python
pe.paid_amount = amt
```

### Step 12: Assign unknown.allocated_amount = amt

```python
pe.get('references')[0].allocated_amount = amt
```

### Step 13: Assign pe = pe.save.submit(...)
...
*Source: test_payment_ledger_entry.py:452 | Complexity: Advanced | Last updated: 2026-02-03*