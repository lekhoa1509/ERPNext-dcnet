# How To: Subscription Cancellation Invoices
...
Workflow: test subscription cancellation invoices
...
### Step 9: Assign invoice = subscription.get_current_invoice(...)

```python
invoice = subscription.get_current_invoice()
```

### Step 10: Assign diff = flt(...)

```python
diff = flt(date_diff(nowdate(), subscription.current_invoice_start) + 1)
```

### Step 11: Assign plan_days = flt(...)

```python
plan_days = flt(date_diff(subscription.current_invoice_end, subscription.current_invoice_start) + 1)
```

### Step 12: Assign prorate_factor = flt(...)
...
### Step 16: Assign settings.prorate = to_prorate
...
*Source: test_subscription.py:188 | Complexity: Advanced | Last updated: 2026-02-03*