# How To: Login Using Authorization Code
...
Workflow: test login using authorization code
...
### Step 15: Assign decoded_token = self.decode_id_token(...)
...
*Source: test_oauth20.py:106 | Complexity: Advanced | Last updated: 2026-02-04*