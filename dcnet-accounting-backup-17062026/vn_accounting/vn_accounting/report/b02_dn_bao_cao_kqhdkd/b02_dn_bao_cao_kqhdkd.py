"""B02-DN Báo cáo kết quả hoạt động kinh doanh (Income Statement) — TT99/2025."""
...
def _get_data(company, period_start, period_end):
    mapping_lines = _load_bctc_mapping(company, "b02")
...
def _load_bctc_mapping(company, report_type):
    ...
    child_field = field_map.get(report_type, "b02_lines")
