...
| 14 | Cài đặt kế toán | Cấu hình | TK mặc định + ngưỡng cho toàn phân hệ (quan trọng nhất) |
...
4. **Cấu hình kho:** [Cài đặt kho](cai-dat-kho.md) — phương pháp tính giá xuất, tồn âm.
...
- **Kho:** [Cài đặt kho](cai-dat-kho.md).
...
**A:** Theo thứ tự: (1) Cây tài khoản (import + tinh chỉnh), (2) Năm tài chính, (3) Cài đặt kế toán (TK mặc định + ngưỡng), (4) Cài đặt kho, (5) Trung tâm chi phí/Dự án, (6) Cài đặt Hợp đồng/PAKD. Đặt đúng nền tảng trước khi nhập chứng từ.
