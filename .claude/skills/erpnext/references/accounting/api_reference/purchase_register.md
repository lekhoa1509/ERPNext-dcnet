# API Reference: purchase_register.py

**Language**: Python

**Source**: `report/purchase_register/purchase_register.py`
...
### _execute(filters = None, additional_table_columns = None)
...
### get_invoice_expense_map(invoice_list)
...
### get_invoice_tax_map(invoice_list, invoice_expense_map, expense_accounts, include_payments = False)
...
### get_account_details(invoice_list)
