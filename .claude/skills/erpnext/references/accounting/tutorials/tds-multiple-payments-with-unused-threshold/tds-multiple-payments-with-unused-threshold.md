# How To: Tds Multiple Payments With Unused Threshold
...
Workflow: Test multiple payment entries with unused threshold (tax_on_excess_amount enabled).
...
### Step 6: Assign pe1.tax_withholding_category = 'New TDS Category'
...
### Step 14: Assign pe2.tax_withholding_category = 'New TDS Category'
...
*Source: test_tax_withholding_category.py:819 | Complexity: Advanced | Last updated: 2026-02-03*