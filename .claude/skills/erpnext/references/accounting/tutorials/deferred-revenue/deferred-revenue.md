...
Workflow: test deferred revenue
...
### Step 4: Assign unknown.deferred_revenue_account = value

```python
item.item_defaults[0].deferred_revenue_account = self.deferred_revenue_account
```

### Step 5: Assign item.no_of_months = 3
...
### Step 8: Assign unknown.income_account = value

```python
si.items[0].income_account = self.income_account
```

### Step 9: Assign unknown.enable_deferred_revenue = 1
...
### Step 12: Assign unknown.deferred_revenue_account = value
...
### Step 15: Assign pda = frappe.get_doc(...)
...
### Step 16: Call pda.insert()

```python
pda.insert()
```

### Step 17: Call pda.submit()

```python
pda.submit()
```

### Step 18: Assign fiscal_year = frappe.get_doc(...)

```python
fiscal_year = frappe.get_doc('Fiscal Year', get_fiscal_year(date='2021-05-01')[0])
```

### Step 19: Assign self.filters = frappe._dict(...)
...
### Step 20: Assign report = Deferred_Revenue_and_Expense_Report(...)

```python
report = Deferred_Revenue_and_Expense_Report(filters=self.filters)
```

### Step 21: Call report.run()
...
*Source: test_deferred_revenue_and_expense.py:74 | Complexity: Advanced | Last updated: 2026-02-03*