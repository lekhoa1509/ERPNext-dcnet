...
Workflow: test serial no qty less
...
### Step 4: Assign unknown.serial_no = 'ABCD'

```python
se.get('items')[0].serial_no = 'ABCD'
```

### Step 5: Assign unknown.transfer_qty = 2

```python
se.get('items')[0].transfer_qty = 2
```

### Step 6: Assign bundle_id = make_serial_batch_bundle(...)
...
*Source: test_stock_entry.py:619 | Complexity: Advanced | Last updated: 2026-02-04*