# How To: Purchase Receipt No Gl Entry
...
Workflow: test purchase receipt no gl entry
...
### Step 4: Assign stock_value_difference = frappe.db.get_value(...)
...
### Step 6: Assign current_bin_stock_value = frappe.db.get_value(...)
...
### Step 9: Call pr.cancel()

```python
pr.cancel()
```

### Step 10: Call make_stock_entry()
...
*Source: test_purchase_receipt.py:158 | Complexity: Advanced | Last updated: 2026-02-04*