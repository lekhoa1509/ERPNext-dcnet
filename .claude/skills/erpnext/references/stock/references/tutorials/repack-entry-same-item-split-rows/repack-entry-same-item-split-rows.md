# How To: Repack Entry Same Item Split Rows
...
Workflow: Split consumption rows and have single repacked item row (same warehouse).
Ledger:
Item    | Qty | Voucher
------------------------
Item 1  | 500 | 001
...
*Source: test_stock_ageing.py:304 | Complexity: Advanced | Last updated: 2026-02-04*