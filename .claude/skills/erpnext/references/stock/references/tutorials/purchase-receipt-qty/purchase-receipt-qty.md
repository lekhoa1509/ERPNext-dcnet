...
Workflow: test purchase receipt qty
...
### Step 5: Assign unknown.rejected_warehouse = '_Test Rejected Warehouse - _TC'

```python
pr.items[0].rejected_warehouse = '_Test Rejected Warehouse - _TC'
```

### Step 6: Assign unknown.rejected_qty = 1

```python
pr.items[0].rejected_qty = 1
```

### Step 7: Assign unknown.qty = 0
...
*Source: test_purchase_receipt.py:35 | Complexity: Advanced | Last updated: 2026-02-04*