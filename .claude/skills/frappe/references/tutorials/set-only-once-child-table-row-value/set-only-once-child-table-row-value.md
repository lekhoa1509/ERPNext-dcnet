# How To: Set Only Once Child Table Row Value
...
Workflow: test set only once child table row value
...
### Step 4: Assign unknown.fieldtype = 'Check'
...
*Source: test_permissions.py:287 | Complexity: Intermediate | Last updated: 2026-02-04*