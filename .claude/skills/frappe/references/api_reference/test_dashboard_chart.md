# API Reference: test_dashboard_chart.py

**Language**: Python

**Source**: `desk/doctype/dashboard_chart/test_dashboard_chart.py`
...
### insert_test_records(doctype_name)
...
### create_new_record(doctype_name, title, date, number)
