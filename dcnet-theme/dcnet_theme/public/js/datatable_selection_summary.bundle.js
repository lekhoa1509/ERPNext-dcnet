...
(function () {
	...
	function updateSummary() {
		...
		const cells = Array.from(rawCells).filter((c) => {
			...
			// Ignore highlighted cells left behind in a navigated-away page
			// container: Frappe keeps the previous page in the DOM (display:none),
			// so a selection made in a report you left would otherwise keep the
			// bar alive on the next page (FB-2026-01082). offsetParent === null
			// means the cell is inside a hidden ancestor — not on the active page.
