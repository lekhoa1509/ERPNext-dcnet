...
> Location: `.Codex/skills/dcnet_quality/`

**Cách hoạt động:**
- **Auto-trigger khi viết code**: Codex detect keyword (VD: `frappe.call`, `hooks.py`, `@frappe.whitelist`) → tự load SKILL.md tương ứng → áp dụng patterns
