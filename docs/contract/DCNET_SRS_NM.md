...
| **Phiên bản** | 1.0.0 |
| **Ngày tạo** | 03/02/2026 |
| **Khách hàng** | Công ty TNHH Nhật Minh Sport |
| **Nhà cung cấp** | DCNET Corporation |
| **Tài liệu số** | PHỤ LỤC SỐ 02 - Hợp đồng DCNET-NMS |
...
Tài liệu Đặc tả Yêu cầu Phần mềm (SRS) này mô tả chi tiết các yêu cầu chức năng và phi chức năng của hệ thống **DCNET Flow** - Giải pháp Quản lý Doanh nghiệp Toàn diện dành cho Công ty TNHH Nhật Minh Sport.

Tài liệu này được sử dụng làm:
- Phụ lục hợp đồng giữa DCNET Corporation và Công ty TNHH Nhật Minh Sport
...
| STT | Phân hệ | Mô tả |
|-----|---------|-------|
| 1 | **CRM** | Quản lý Lead, Khách hàng, Chăm sóc khách hàng, Tích điểm |
...
| 6 | **Dịch vụ Golf** | Fitting, Thu cũ Đổi mới |
| 7 | **Tích hợp** | E-commerce, Messaging, Web API |
| 8 | **Báo cáo** | Dashboard, Analytics, Business Intelligence, Web Analytics |
...
| STT | Tài liệu | Mô tả |
|-----|----------|-------|
| 1 | PHỤ LỤC SỐ 01 - Hợp đồng DCNET-NMS | Tài liệu yêu cầu gốc từ khách hàng |
...
- **Dịch vụ chuyên biệt**: Fitting, Trade-in
- **Bán hàng đa kênh**: Cửa hàng, Website, TMĐT (Shopee, TikTok, Lazada)
...
│   ┌─────────────────────────────────────────────────────────────────────┐   │
│   │                     BÁO CÁO & PHÂN TÍCH                             │   │
│   │        (Dashboard, Reports, Analytics, Web Analytics)               │   │
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│   │                                                                     │   │
│   │  ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌─────────────┐   │   │
│   │  │ Viettel │ │  Shopee │ │ TikTok  │ │  Lazada │ │ Zalo/Mess.  │   │   │
│   │  │  Post   │ │   API   │ │   API   │ │   API   │ │    API      │   │   │
│   │  └─────────┘ └─────────┘ └─────────┘ └─────────┘ └─────────────┘   │   │
│   │                                                                     │   │
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                              │
...
| **Nhân viên Kinh doanh** | Tạo đơn hàng, chăm sóc KH | CRM, Bán hàng, Fitting |
...
2. Khách hàng cung cấp tài khoản API các nền tảng (Shopee, TikTok, Lazada, Viettel Post)
...
| Shopee Open Platform | Đồng bộ đơn hàng | Shopee |
| TikTok Shop API | Đồng bộ đơn hàng | TikTok |
| Lazada Open Platform | Đồng bộ đơn hàng | Lazada |
| Zalo OA API | Messaging, thông báo | Zalo |
| Facebook Messenger API | Messaging | Meta |
...
Cung cấp hệ thống xác thực người dùng và nền tảng cơ sở cho toàn bộ ứng dụng DCNET Flow. Bao gồm đăng nhập, đăng xuất, quản lý phiên làm việc và giao diện chung của hệ thống.

### 3.1.2. Tính năng chính

- Đăng nhập/Đăng xuất bằng tài khoản hệ thống
- Quản lý phiên làm việc (session timeout)
- Giao diện nền tảng chung (sidebar, header, navigation)
...
Quản lý danh sách nhà cung cấp bao gồm thông tin liên hệ, điều khoản thanh toán, và lịch sử giao dịch. Hỗ trợ phân loại nhà cung cấp theo nhóm và theo dõi hiệu suất cung ứng.

### 3.4.2. Tính năng chính

- Danh sách nhà cung cấp (tên, mã, liên hệ, nhóm NCC)
- Tạo/Sửa/Xóa thông tin nhà cung cấp
- Phân loại nhà cung cấp theo nhóm (nội địa, quốc tế, theo hãng)
...
Cung cấp các báo cáo phân tích tổng hợp phục vụ việc ra quyết định kinh doanh. Bao gồm phân tích xu hướng, so sánh kỳ, và các chỉ số KPI quan trọng.

### 3.6.2. Tính năng chính

- Báo cáo phân tích xu hướng doanh số
- So sánh doanh số giữa các kỳ (tháng/quý/năm)
- Phân tích hiệu quả kinh doanh theo nhóm sản phẩm
- Phân tích top sản phẩm bán chạy / chậm luân chuyển
...
| Nguồn đơn | Online / Cửa hàng / TMĐT |
...
### 3.9.4. Đồng bộ đơn hàng TMĐT

**REQ-ORDER-010:** Kết nối sàn TMĐT
- Shopee: Tự động nhận đơn hàng mới
- TikTok: Tự động nhận đơn hàng mới
- Lazada: Tự động nhận đơn hàng mới
- Website: API đồng bộ đơn hàng

**REQ-ORDER-011:** Đồng bộ trạng thái
- Cập nhật trạng thái đơn hàng lên sàn TMĐT
- Cập nhật mã vận đơn lên sàn TMĐT
...
### 3.10.1. Chính sách Chiết khấu Bán buôn
...
### 3.11.1. Chính sách Chiết khấu Bán lẻ
...
Quản lý các danh mục phục vụ quy trình bán hàng bao gồm: kênh bán hàng, nguồn đơn hàng, phương thức thanh toán, và các cấu hình liên quan đến chính sách bán hàng.

### 3.13.2. Tính năng chính

- Quản lý danh mục kênh bán hàng (Cửa hàng, Online, TMĐT)
- Quản lý danh mục nguồn đơn hàng
- Quản lý phương thức thanh toán
- Quản lý nhóm khách hàng bán hàng
...
Quản lý thông tin các chi nhánh, cửa hàng của công ty bao gồm địa chỉ, nhân sự, kho hàng liên kết và hiệu quả kinh doanh theo từng chi nhánh.

### 3.15.2. Tính năng chính

- Danh sách chi nhánh (tên, mã, địa chỉ, người phụ trách)
- Tạo/Sửa/Xóa thông tin chi nhánh
- Liên kết chi nhánh với kho hàng
...
Quản lý danh sách nhân viên của công ty phục vụ cho việc phân công công việc, theo dõi hiệu suất và phân quyền hệ thống.

### 3.16.2. Tính năng chính

- Danh sách nhân viên (tên, mã, chức vụ, chi nhánh, phòng ban)
- Tạo/Sửa thông tin nhân viên
- Liên kết nhân viên với tài khoản hệ thống
...
Cung cấp các báo cáo tổng hợp dành cho ban lãnh đạo và quản lý, giúp theo dõi hiệu quả hoạt động kinh doanh toàn diện.

### 3.19.2. Tính năng chính

- Báo cáo tổng hợp doanh thu theo chi nhánh
- Báo cáo hiệu quả kinh doanh theo kỳ
...
Quản lý các nghiệp vụ kế toán liên quan đến mua hàng bao gồm hạch toán hóa đơn mua, chi phí nhập khẩu, và đối chiếu thanh toán nhà cung cấp.

### 3.24.2. Tính năng chính

- Hạch toán hóa đơn mua hàng trong nước
- Hạch toán hóa đơn nhập khẩu (chi phí vận chuyển, thuế nhập khẩu)
...
Quản lý nghiệp vụ kế toán hàng tồn kho bao gồm tính giá vốn hàng bán, hạch toán nhập xuất kho và đối chiếu giá trị tồn kho với sổ kế toán.

### 3.27.2. Tính năng chính

- Tính giá vốn hàng bán (phương pháp bình quân gia quyền)
- Hạch toán tự động khi nhập/xuất kho
...
### 3.28.1. Theo dõi chi phí theo sự kiện
...
Quản lý tài sản cố định và công cụ dụng cụ của doanh nghiệp bao gồm theo dõi khấu hao, phân bổ chi phí và kiểm kê tài sản.

### 3.29.2. Tính năng chính

- Danh mục tài sản cố định (mã, tên, nguyên giá, khấu hao lũy kế)
- Tính khấu hao tự động theo phương pháp đường thẳng
- Quản lý công cụ dụng cụ (phân bổ chi phí)
...
Quản lý nghiệp vụ kế toán thuế bao gồm thuế GTGT, thuế TNDN, thuế nhập khẩu và các loại thuế khác theo quy định pháp luật Việt Nam.

### 3.30.2. Tính năng chính

- Kê khai thuế GTGT đầu vào/đầu ra
- Bảng kê hóa đơn mua/bán theo kỳ
- Tính thuế TNDN tạm tính theo quý
...
Quản lý sổ cái, hệ thống tài khoản kế toán và các bút toán tổng hợp theo Thông tư 200/2014/TT-BTC. Cung cấp nền tảng cho toàn bộ hệ thống kế toán.

### 3.31.2. Tính năng chính

- Hệ thống tài khoản kế toán theo TT200
- Sổ cái tổng hợp và chi tiết
- Bút toán điều chỉnh, kết chuyển cuối kỳ
...
## 3.35. Cài đặt hệ thống

### 3.35.1. Mô tả

Cung cấp giao diện cấu hình các thông số hệ thống bao gồm thông tin công ty, các tham số nghiệp vụ, template email/thông báo và các cài đặt chung.

### 3.35.2. Tính năng chính

- Cấu hình thông tin công ty (tên, logo, địa chỉ, MST)
- Cài đặt tham số nghiệp vụ (năm tài chính, đơn vị tiền tệ, múi giờ)
- Quản lý template email, thông báo
- Cấu hình chính sách mặc định (hạn thanh toán, chiết khấu)

> ⚠️ Chi tiết sẽ được bổ sung khi có thêm thông tin từ khách hàng

---

## 3.36. Chăm sóc Khách hàng tự động

> **Giai đoạn:** Bàn giao T6 (30/06/2026)

### 3.36.1. Lịch chăm sóc tự động
...
### 3.36.2. Lịch gửi khuyến mãi tự động
...
### 3.36.4. Khảo sát mức độ hài lòng
...
### 3.36.5. Gợi ý Upsell/Cross-sell
...
## 3.37. Quản lý Tích điểm (Loyalty) &nbsp; &#9733; NM only

> **Giai đoạn:** Bàn giao T6 (30/06/2026)

### 3.37.1. Quy tắc tích điểm

**REQ-CUST-008:** Quy tắc tích điểm
- Định nghĩa tỷ lệ tích điểm theo doanh số
- Tích điểm theo sản phẩm/nhóm sản phẩm
- Điểm có hiệu lực trong thời hạn

### 3.37.2. Quy tắc lên hạng

**REQ-CUST-009:** Quy tắc lên hạng
- Định nghĩa các hạng thành viên (Bronze, Silver, Gold, Platinum)
- Điều kiện lên hạng (doanh số tích lũy)
- Quyền lợi theo hạng

### 3.37.3. Đổi điểm

**REQ-CUST-010:** Đổi điểm
...
### 3.41.1. Phân tích website

**REQ-RPT-008:** Phân tích website
- Lượt truy cập
- Tỉ lệ chuyển đổi
- Heatmap
- Session recording
...
## 3.42. Web & Đồng bộ &nbsp; &#9733; NM only

> **Giai đoạn:** Bàn giao T6 (30/06/2026)

### 3.42.1. API đồng bộ Website

**REQ-ECOM-004:** API đồng bộ Website
- API sản phẩm (GET)
- API khách hàng (GET/POST)
- API tồn kho (GET)
- API đơn hàng (POST)

---

## 3.43. E-commerce &nbsp; &#9733; NM only

> **Giai đoạn:** Bàn giao T6 (30/06/2026)

### 3.43.1. Shopee

**REQ-ECOM-001:** Tích hợp Shopee Shop
- Đồng bộ sản phẩm (DCNET → Shopee)
- Đồng bộ tồn kho (DCNET → Shopee)
- Nhận đơn hàng (Shopee → DCNET)
- Cập nhật trạng thái đơn (DCNET → Shopee)

### 3.43.2. TikTok Shop

**REQ-ECOM-002:** Tích hợp TikTok Shop
- Đồng bộ sản phẩm
- Đồng bộ tồn kho
- Nhận đơn hàng
...
## 3.44. Messaging &nbsp; &#9733; NM only

> **Giai đoạn:** Bàn giao T6 (30/06/2026)

### 3.44.1. Zalo OA

**REQ-MSG-001:** Tích hợp Zalo OA
- Gửi tin nhắn chăm sóc khách hàng
- Gửi thông báo đơn hàng
- Gửi nhắc lịch (Fitting)
- Nhận tin nhắn từ khách (tạo ticket)

### 3.44.2. Facebook Messenger

**REQ-MSG-002:** Tích hợp Messenger
...
Cung cấp các công cụ kiểm soát nội bộ giúp ban lãnh đạo giám sát hoạt động, phát hiện bất thường và đảm bảo tuân thủ quy trình nghiệp vụ.

### 3.45.2. Tính năng chính

- Theo dõi log hoạt động người dùng
- Cảnh báo bất thường (sửa giá, xóa đơn, vượt hạn mức)
...
Xem file đính kèm: **[Phụ lục A - Feature Matrix](appendix/nm/A_FEATURE_MATRIX.md)**

## 6.2. Sơ đồ ERD

Xem file đính kèm: **[Phụ lục B - ERD Diagrams](appendix/nm/B_ERD_DIAGRAMS.md)**

## 6.3. Sơ đồ Workflow

Xem file đính kèm: **[Phụ lục C - Workflow Diagrams](appendix/nm/C_WORKFLOW_DIAGRAMS.md)**

## 6.4. Ma trận Phân quyền

Xem file đính kèm: **[Phụ lục D - Permission Matrix](appendix/nm/D_PERMISSION_MATRIX.md)**
...
|---------|--------|--------|------|
| **Bên A (Khách hàng)** | | | |
| Đại diện Công ty TNHH Nhật Minh Sport | _________________ | _________________ | ____/____/2026 |
| **Bên B (Nhà cung cấp)** | | | |
...
**Tài liệu này là phụ lục của Hợp đồng số .../HĐDV/DCNET-NMS**
