...
# Đăng ký nguồn tài liệu kế toán do hệ thống tự sinh — báo cáo
# "Tài liệu tự động" trong app vn_accounting sẽ tự nhận diện.
auto_generated_doc_sources = {
    "dcnet_contract.auto_invoice": {
        "label": "Hóa đơn bán hàng tự động từ Hợp đồng",
        "doctype": "Sales Invoice",
        "needs_approval": True,
        "action_draft": "Duyệt, ghi sổ và xuất hóa đơn điện tử",
        "description": "Hệ thống tự sinh hàng ngày cho mỗi kỳ trong Lịch thu tiền của Hợp đồng đến hạn. Kế toán xem lại, ghi sổ rồi xuất hóa đơn điện tử.",
    },
}
