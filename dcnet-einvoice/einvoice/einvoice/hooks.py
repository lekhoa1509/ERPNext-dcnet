...
# --------------------------------------------------------------------------
# Defined via fixtures or install hooks; see einvoice.einvoice/install.py
...
scheduler_events = {
    "cron": {
        "*/15 * * * *": [
            ...
            "einvoice.einvoice.tasks.sync_outward_states.run_if_frequency_match",
        ],
    },
    "hourly": [
        "einvoice.einvoice.tasks.sync_inward_invoices.run_if_frequency_match",
