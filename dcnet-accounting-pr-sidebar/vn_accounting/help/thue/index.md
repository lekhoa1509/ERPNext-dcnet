...
| 7 | Danh mục thuế | Danh sách | Nhóm phân loại thuế dùng cho khách hàng, nhà cung cấp, giao dịch |
| 8 | Quy tắc thuế | Danh sách | Tự chọn mẫu thuế bán/mua theo danh mục thuế, đối tượng, mặt hàng |
| 9 | Danh mục thuế khấu trừ | Danh sách | Cấu hình thuế khấu trừ tại nguồn khi cần áp dụng |
| 10 | [Đang phát triển] Kiểm tra MST | Công cụ | Tra cứu tình trạng mã số thuế nhà cung cấp (chưa hoàn thiện) |

### Quy trình điển hình

1. **Cấu hình ban đầu:** lập danh mục thuế, quy tắc thuế, các mẫu thuế bán hàng (5%, 8%, 10%), mẫu thuế mua hàng, và mẫu thuế hàng hóa cho các mặt hàng có thuế suất riêng.
...
- **Cấu hình thuế:** [Danh mục thuế](danh-muc-thue.md), [Quy tắc thuế](quy-tac-thue.md), [Danh mục thuế khấu trừ](danh-muc-thue-khau-tru.md).
