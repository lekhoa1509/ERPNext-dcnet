...
function _test_connection(frm) {
    ...
    frappe.call({
        method: "dcnet_apps.einvoice.doctype.einvoice_provider.einvoice_provider.test_connection",
...
function _refresh_templates(frm) {
    ...
    frappe.call({
        method: "dcnet_apps.einvoice.doctype.einvoice_provider.einvoice_provider.refresh_templates",
        args: { docname: frm.docname },
        callback(r) {
            frappe.dom.unfreeze();
            if (!r.exc && r.message) {
